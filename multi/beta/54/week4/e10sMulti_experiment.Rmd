...
```{r, echo=FALSE}
htmltools::includeHTML('./week4/html/GC_MAX_PAUSE_MS.html')
```
...
```{r, echo=FALSE}
htmltools::includeHTML('./week4/html/CYCLE_COLLECTOR_MAX_PAUSE.html')
```
...
```{r, echo=FALSE}
htmltools::includeHTML('./week4/html/INPUT_EVENT_RESPONSE_MS.html')
```
...
```{r, echo=FALSE}
htmltools::includeHTML('./week4/html/FX_PAGE_LOAD_MS.html')
```
...
```{r, echo=FALSE}
htmltools::includeHTML('./week4/html/FX_TAB_REMOTE_NAVIGATION_DELAY_MS.html')
```
...
```{r, echo=FALSE}
htmltools::includeHTML('./week4/html/FX_TAB_SWITCH_SPINNER_VISIBLE_LONG_MS.html')
```
...
```{r, echo=FALSE}
htmltools::includeHTML('./week4/html/FX_TAB_SWITCH_SPINNER_VISIBLE_MS.html')
```
##### FX_TAB_SWITCH_TOTAL_MS {.tabset .tabset-fade}


```{r, echo=FALSE}
htmltools::includeHTML('./week4/html/FX_TAB_SWITCH_TOTAL_MS.html')
```
...
```{r, echo=FALSE}
htmltools::includeHTML('./week4/html/FX_TAB_SWITCH_UPDATE_MS.html')
```
...
```{r, echo=FALSE}
htmltools::includeHTML('./week4/html/MEMORY_DISTRIBUTION_AMONG_CONTENT.html')
```
...
```{r, echo=FALSE}
htmltools::includeHTML('./week4/html/MEMORY_TOTAL.html')
```
...
```{r, echo=FALSE}
htmltools::includeHTML('./week4/html/MEMORY_VSIZE_MAX_CONTIGUOUS.html')
```
...
```{r, echo=FALSE}
htmltools::includeHTML('./week4/html/SLOW_SCRIPT_NOTICE_COUNT.html')
```
...
```{r, echo=FALSE}
htmltools::includeHTML('./week4/html/SLOW_SCRIPT_PAGE_COUNT.html')
```
...
```{r, echo=FALSE}
htmltools::includeHTML('./week4/html/SLOW_SCRIPT_NOTIFY_DELAY.html')
```
